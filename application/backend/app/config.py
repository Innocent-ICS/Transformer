...
MODEL_CONFIGS = [
    {
        ...
        "type": "translation",
        "checkpoint_path": "../../../ml/checkpoints/translation-final_best.pth.tar",
        "config": {
            "src_vocab_size": 1950,
            "trg_vocab_size": 2249,
            "d_model": 256,
        ...
        "tokenizer_config": {
            "src_vocab_file": "../../../ml/Train/shona.txt",
            "trg_vocab_file": "../../../ml/Train/english.txt",
            "min_freq": 2
        },
        "metadata": {
    ...
    },
    {
        ...
        "type": "generation",
        "checkpoint_path": "../../../ml/checkpoints/shona-100K-final_best.pth.tar",
        "config": {
            "vocab_size": 58227,
            "d_model": 256,
            "n_layers": 3,
        ...
        "tokenizer_config": {
            "vocab_file": "../../../ml/Train/shona_100K_train.txt",
            "min_freq": 2
        },
        "metadata": {
    ...
    },
    {
        ...
        "type": "generation",
        "checkpoint_path": "../../../ml/checkpoints/generation-final_best.pth.tar",
        "config": {
            "vocab_size": 1950,
            "d_model": 256,
            "n_layers": 3,
