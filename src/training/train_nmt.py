...
from src.data.text_data import get_dataloaders
...
def main():
    ...
    train_loader, val_loader, test_loader, src_tokenizer, trg_tokenizer = get_dataloaders(
        'data/Train/Flores-200/Shona/shona.txt', 'data/Train/Flores-200/Shona/english.txt',
        'data/Test/Flores-200/Shona/shona_test.txt', 'data/Test/Flores-200/Shona/english_test.txt',
        args.batch_size
    )
