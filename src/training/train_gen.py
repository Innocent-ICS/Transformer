...
from src.models.transformer import make_lm_model
from src.data.text_data import get_generation_dataloaders
from src.utils.common import set_seed, save_checkpoint
...
def main():
    ...
    parser.add_argument('--train_path', type=str, default='data/Train/Flores-200/Shona/shona.txt')
    parser.add_argument('--dev_path', type=str, default=None)
    parser.add_argument('--test_path', type=str, default='data/Test/Flores-200/Shona/shona_test.txt')
    ...
    for epoch in range(args.epochs):
        ...
        if valid_loss < best_valid_loss:
            ...
            save_checkpoint({
                ...
                'loss': valid_loss,
            }, filename=f"saved_models/checkpoints/{args.run_name}_best.pth.tar")
