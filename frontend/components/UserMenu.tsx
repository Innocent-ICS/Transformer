...
export function UserMenu({ theme, onThemeToggle }: UserMenuProps) {
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            >
                <div className={`w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 ${theme === 'dark'
            ...
            {isOpen && (
                <div className={`absolute bottom-full left-0 mb-2 w-64 rounded-xl shadow-xl overflow-hidden z-50 border ${theme === 'dark'
                    ...
                    <div className={`px-4 py-3 border-b ${theme === 'dark' ? 'border-[#2a2a2a]' : 'border-gray-200/50'
                        }`}>
                        ...
                        <div className={`mt-2 inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-xs ${theme === 'dark'
